    ...
    extends TestCase
{
     ...
     */
    public SchubsLTest( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( SchubsLTest.class );
    }
    ...
    public static boolean compareFiles() throws IOException
              {
                    ...
                    for(int i = 0; i < 4; i++) {
                        ...
                        //  File deleteMe = new File("src" + File.separator + "decompressed"
    ...
    public void testSchubsL() throws IOException
    {
        ...
        String[] args2 = {"src" + File.separator + "compressed" + File.separator + "compressedFile0.txt.ll",
